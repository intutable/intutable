...
async function main() {
    ...
    const events = new core_1.EventSystem(true); // debug mode
...
async function waitForDatabase() {
    ...
    while (retries > 0 && !connected) {
        console.log(`${path_1.default.basename(__filename)}: waiting for database...`);
        console.log(`${path_1.default.basename(__filename)}: retries: ${retries}`);
