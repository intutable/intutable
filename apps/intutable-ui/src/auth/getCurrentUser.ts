import { getCurrentUser as getCurrentUserRequest } from "@intutable-org/user-authentication/dist/requests"
import { ADMIN_ROLE } from "../../../../libs/dekanat-app-plugin/dist/permissions"
